...
public class CardInHand : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler
{
    ...
    void FixedUpdate()
    {
        ...
        if (hideTimer > 0f)
        {
            ...
            if (hideTimer <= 0f)
            {
                // Draw a new card.
                if (good)
                    GM.I.goodLeader.DrawCard(index);
                else
                    GM.I.evilLeader.DrawCard(index);
        ...
        if (destination.z >= 0f)
        {
            ...
            {
                // Remove from GM's list of cards in the air.
                GM.I.cardsInTheAir.Remove(this);
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (InputManager.I.selectedCard != this)
            Select();
        else
            Deselect();
    }
    ...
    public void Select()
    {
        ...
        InputManager.I.selectedCard = this;
    ...
    {
        // Clear selection.
        InputManager.I.selectedCard = null;
