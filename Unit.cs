...
public class Unit : MonoBehaviour
{
    ...
    void Start()
    {
        // Units, structures, and summons register with GM.
        if (cardType == "Unit" || cardType == "Structure" || role == "Summon")
        {
            if (good)
            {
                // Good units.
                GM.I.goodUnits[laneIndex].Add(this);
            }
            else
            {
                // Evil units.
                GM.I.evilUnits[laneIndex].Add(this);
            }
        }
    }
    ...
    void FixedUpdate()
    {
        ...
        if (state == 1)
        {
            ...
            // Update current tile.
            int tileX = Mathf.Clamp(Mathf.FloorToInt(transform.position.x), 0, GM.I.gridWidth - 1);
            currentTile = GM.I.grid[tileX, laneIndex];
        }
    }
    ...
    {
        if (good)
            return GM.I.goodLeader;
        else
            return GM.I.evilLeader;
    }
    ...
    public void LookForEnemy()
    {
        ...
        List<Unit> enemyUnits = GM.I.GetEnemiesInLane(this);
    ...
    public bool IsVisible()
    {
        ...
        List<Unit> enemyUnits = GM.I.GetAllEnemies(this);
    ...
    public void LoseHealth(float healthLost, Unit source = null, bool ignoreArmor = false, bool damageFlash = true)
    {
        ...
        if (keywords.Contains("Vital"))
        {
            // Leader loses health.
            if (good)
                GM.I.goodLeader.LoseHealth(healthLost, source);
            else
                GM.I.evilLeader.LoseHealth(healthLost, source);
    ...
    public void Death()
    {
        ...
        // Remove from GM's list of units.
        if (good)
            GM.I.goodUnits[laneIndex].Remove(this);
        else
            GM.I.evilUnits[laneIndex].Remove(this);
    ...
    public void ChangeSides()
    {
        ...
        if (good)
        {
            ...
            // Remove from GM's list of good units.
            GM.I.goodUnits[laneIndex].Remove(this);

            // Add to GM's list of evil units.
            GM.I.evilUnits[laneIndex].Add(this);
        } else {
            // Evil to good?
            ...
            // Remove from GM's list of evil units.
            GM.I.evilUnits[laneIndex].Remove(this);

            // Add to GM's list of good units.
            GM.I.goodUnits[laneIndex].Add(this);
        }
    }
}
