    ...
    public void InitializeProgenitors()
    {
        ...
        foreach (Transform child in transform)
        {
            ...
            if (unit.cardType == "Unit")
            {
                ...
                GM.I.grimoire[unit.myName] = GM.I.MakeCard(unit, "Unit");
            }
            ...
            else if (unit.cardType == "Structure")
            {
                ...
                // Add to grimoire in card form.
                GM.I.grimoire[unit.myName] = GM.I.MakeCard(unit, "Structure");
            }
            ...
            else if (unit.cardType == "Spell")
            {
                ...
                // Add to grimoire in card form.
                GM.I.grimoire[unit.myName] = GM.I.MakeCard(unit, "Spell");
            }
            else if (unit.cardType == "Item")
            {
                ...
                // Add to grimoire in card form.
                GM.I.grimoire[unit.myName] = GM.I.MakeCard(unit, "Item");
            }
            else
            {
